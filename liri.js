...
//users most recent tweets

var client = new Twitter({
	consumer_key: '<J9wjA3n9EO4TqETOLmQHqgKhw>',
  consumer_secret: '<nNFaCEg5cpFDnR7UHxwHclhdtfBAKFFPclsR0Q9DXivuYy6wzP>',
  access_token_key: '<718266419406876672-ICLV2TwDchGSroMKDLOiBvPze3SeFig>',
  access_token_secret: '<k5vigVdLnB5xuu31VJkycXwaozIhlaCVMnz960tBpJcmH>',
});

function theTweets(){
	var params = {screen_name: 'Tkoni', count:20};
